...
//Координата пложения в меню
static int8_t navi[] = {0, 0, 0};
//Текущая горизонтальная позиция в меню
static int8_t xPos = 0;
//Выбранный разряд для редактирования
static int8_t cursor = 0;
//Наименования пунктов меню уровня 0
static char* menu0Strings[] = {"ISIg", " LI ", "USE ", "2POS", "3POS", "PId "};
//Наименования пунктов меню уровня 1
